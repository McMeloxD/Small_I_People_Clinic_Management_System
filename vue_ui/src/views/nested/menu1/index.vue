    ...
    <el-card class="box-card">
      ...
      <el-form :inline="true" :model="keyword" class="demo-form-inline">
        ...
        <el-form-item>
          ...
          <el-input v-model="keyword.orderNumber" placeholder="请输入订单编号" style="width: 250px" clearable></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <el-table :data="tableData" style="width: 100%;font-size: 13px" @selection-change="handleSelectionChange">
        ...
        <el-table-column align="center" prop="buillId" label="序号"></el-table-column>
        ...
        <el-table-column align="center" prop="patientName" label="姓名" width="70px"></el-table-column>
        ...
        <el-table-column align="center" prop="patientContact" label="手机号码"></el-table-column>
...
<script>
import {getList,delById,update,delByIds} from "@/api/all";

  ...
  <div>
    <el-card class="box-card">
      ...
      <el-table :data="tableData" style="width: 100%;font-size: 13px" @selection-change="handleSelectionChange">
        ...
        <el-table-column align="center" prop="returnFee" label="退费金额(元)"></el-table-column>
        <el-table-column align="center" prop="paymentMethod" label="退费方式">
          <template slot-scope="scope">
        ...
        <el-table-column align="center" prop="chargingState" label="收费状态">
          <template slot-scope="scope">
            <el-tag :type="scope.row.chargingState == 3 ? 'info' : scope.row.chargingState == 2 ? 'success' : 'danger'">
    ...
    <el-dialog title="收费管理" :visible.sync="dialogFormVisible" width="650px">
      <el-form :inline="true" :model="charge" class="demo-form-inline">
        ...
        <el-form-item label="退费金额(元)">
          <el-input v-model="charge.returnFee"></el-input>
        </el-form-item>
  ...
  methods:{
    ...
    handleDeletes() {
      if (this.chargeList.length == 0) {
        ...
        this.$confirm('是否确认删除"['+this.chargeListName+']"的信息吗？', '提示', {
